...
interface StandardBusinessPlanFormProps {
    businessPlan: BusinessPlanType;
    onSave: (updatedData: BusinessPlanType) => void;
    planId: number;
}

const StandardBusinessPlanForm: React.FC<StandardBusinessPlanFormProps> = ({ businessPlan, onSave, planId }) => {
    ...
    return (
        <div className="space-y-6 p-6 bg-card rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold text-foreground">Standard Business Plan Form</h2>
...
export default StandardBusinessPlanForm;
